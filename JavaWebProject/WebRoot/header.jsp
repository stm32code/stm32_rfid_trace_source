...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">rfid烟草溯源</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>GoodsType/frontlist">商品类型</a></li>
                <li><a href="<%=basePath %>Goods/frontlist">商品查询 </a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>GoodsInto/goodsInto_userFrontAdd.jsp"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;商品rfid查询</a></li>

                        <li><a href="<%=basePath %>UserInfo/userInfo_frontModify.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;修改个人信息</a></li>
                    </ul>
                </li>
