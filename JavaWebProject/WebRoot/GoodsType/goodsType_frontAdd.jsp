		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>GoodsType/frontlist">商品类型列表</a></li>
			    	<li role="presentation" class="active"><a href="#goodsTypeAdd" aria-controls="goodsTypeAdd" role="tab" data-toggle="tab">添加商品类型</a></li>
				</ul>
				<!-- Tab panes -->
