		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#goodsTypeListPanel" aria-controls="goodsTypeListPanel" role="tab" data-toggle="tab">商品类型列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>GoodsType/goodsType_frontAdd.jsp" style="display:none;">添加商品类型</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>商品类型id</td><td>类型名称</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<goodsTypeList.size();i++) {
					    	            		...
					    	            		GoodsType goodsType = goodsTypeList.get(i); //获取到商品类型对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;商品类型信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="goodsType_goodTypeId_edit" class="col-md-3 text-right">商品类型id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="goodsType_goodTypeId_edit" name="goodsType.goodTypeId" class="form-control" placeholder="请输入商品类型id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
